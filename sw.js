const CACHE="fieldscout-v0.9.0-shell";
...
self.addEventListener("fetch",e=>{
  ...
  if(u.hostname.includes("tbiadata.tw")||u.hostname.includes("gbif.org")||u.hostname.includes("inaturalist.org")||u.hostname.includes("taicol.tw")||u.hostname.includes("openstreetmap.org")||u.hostname.includes("unpkg.com"))return;
